		...
		<!-- Collect the nav links, forms, and other content for toggling -->
	  	<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul class="nav navbar-nav">
				<li class="active"> <?php echo anchor('fridge', 'View Invetory'); ?> </a></li>
	...
	foreach($item->result() as $row)
	{
			echo form_open('fridge/modify');
				...
				echo '<div class="form-group">';
					...
					echo form_input('product_name', $row->product_name , 'class=form-control');
				echo '</div>';

				echo '<div class="form-group">';
					echo '<label> Quantity </label>';
					echo form_input('quantity', $row->quantity , 'class=form-control');
				echo '</div>';
				...
				echo '<div class="form-group">';
					...
					$expiryDate = explode('-', $row->expiry_date);

					echo form_dropdown('month', $month, $expiryDate[1], 'class=form-control') 
					. nbs(1) 
					. form_dropdown('day', $day, $expiryDate[2], 'class=form-control') . nbs(1) 
					. form_dropdown('year', $year, $expiryDate[0], 'class=form-control');
				echo '</div>';
